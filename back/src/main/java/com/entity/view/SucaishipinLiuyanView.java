...
public class SucaishipinLiuyanView extends SucaishipinLiuyanEntity implements Serializable {
	...
	public SucaishipinLiuyanView() {

	}

	public SucaishipinLiuyanView(SucaishipinLiuyanEntity sucaishipinLiuyanEntity) {
		try {
			BeanUtils.copyProperties(this, sucaishipinLiuyanEntity);
