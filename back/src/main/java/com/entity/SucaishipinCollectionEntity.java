...
public class SucaishipinCollectionEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public SucaishipinCollectionEntity() {

	}

	public SucaishipinCollectionEntity(T t) {
		try {
    ...
    @TableField(value = "sucaishipin_collection_types")
