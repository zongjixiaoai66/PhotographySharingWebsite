...
var centerMenu = [
    ...
    ,{
        name: '图片素材留言',
        url: '../sucaiLiuyan/list.html'
    }
    ,{
        name: '视频素材收藏',
        url: '../sucaishipinCollection/list.html'
    }
    ,{
        name: '视频素材留言',
        url: '../sucaishipinLiuyan/list.html'
    }
...
var indexNav = [
    ...
    {
        name: '视频素材',
        url: './pages/sucaishipin/list.html'
    },

]

// 已废弃,不用了
var adminurl =  "http://localhost:8080/youguangsheyingwz/admin/dist/index.html#/login";
